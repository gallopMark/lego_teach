...
public class IJKPlayerActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        ...
        if (videoType != null && videoType.equals("course")) {
            ...
            statusUrl = Constants.OUTRT_NET + "/" + activityId + "/teach/m/video/user/" + videoId + "/updateVideoStatus";
            updateUrl = Constants.OUTRT_NET + "/" + activityId + "/teach/m/video/user/" + videoId + "/updateViewTime";
            infoUrl = Constants.OUTRT_NET + "/" + activityId + "/teach/m/activity/ncts/" + activityId + "/view";
