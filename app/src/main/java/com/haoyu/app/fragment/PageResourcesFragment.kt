...
class PageResourcesFragment : BaseFragment(), XRecyclerView.LoadingListener {
    ...
    override fun initView(view: View) {
        ...
        val btUpload = view.findViewById<Button>(R.id.bt_upload)
        ...
        btUpload.setOnClickListener {
            val intent = Intent(context, ResourcesUploadActivity::class.java)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 1 && resultCode == Activity.RESULT_OK && data != null) {
            val entity = data.getSerializableExtra("entity") as ResourcesEntity
            mDatas.add(0, entity)
            adapter.notifyDataSetChanged()
            if (xRecyclerView.visibility != View.VISIBLE) {
                xRecyclerView.visibility = View.VISIBLE
